        ...
        _ = (function() {
          function e(t, n, i) {
            ...
            c(this, e),
              ...
              (this.joinedOnce = !1),
              (this.joinPush = new P(this, T, this.params, this.timeout)),
              (this.pushBuffer = []),
          ...
          return (
            h(e, [
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  ...
                  this.waitForBufferDone(function() {
                    i.conn && (t ? i.conn.close(t, n || "") : i.conn.close()),
                      i.waitForSocketClosed(function() {
                        i.conn &&
                          ((i.conn.onclose = function() {}), (i.conn = null)),
                          e && e();
                      });
                  });
                }
              ...
              },
              {
                ...
                value: function(e) {
                  for (var t in this.stateChangeCallbacks)
                    this.stateChangeCallbacks[t] = this.stateChangeCallbacks[
                      t
                    ].filter(function(t) {
                      var n = r(t, 1)[0];
              ...
              },
              {
                ...
                value: function(e) {
                  (this.closeWasClean = !1),
                    this.conn.readyState === v && this.conn.close(1e3, e);
                }
              },
              {
                key: "flushSendBuffer",
            ...
            h(
              ...
              [
                ...
                },
                {
                  ...
                  value: function() {
                    return (
                      !this.joinRef || this.joinRef !== this.channel.joinRef()
                    );
                  }
                }
              ],
